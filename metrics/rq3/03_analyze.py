...
#
# rq3 is a model-variant comparison (M-Opus / M-Sonnet / M-gpt5.4 / M-Qwen),
# not a per-persona spec test, so we leave CHECKS empty. The fidelity report
# still gets written so the file layout matches rq2; it just contains zero
# checks.
