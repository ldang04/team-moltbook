"""Shared constants, paths, word lists, and HTTP/NLP helpers for the RQ4 pipeline."""
...
# (also used as filenames on disk); values are the persona-friendly names
# the figures and CSVs should render. The control agent stays "control" so
# the rq4 visuals match the convention used in rq2.
DISPLAY_LABELS: dict[str, str] = {
    "baselineagent": "control",
    "shan-ai": "Maverick",
    "shancautious": "Sentinel",
    "shanamnesia": "Drifter",
    "shanlocked": "Ghost",
}
...
class MoltbookClient:
    ...
    def _headers(self, force_auth: bool) -> dict[str, str]:
        headers = {"Accept": "application/json", "User-Agent": "openclaw-rq4/1.0"}
