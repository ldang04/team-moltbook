...
CHECKS: list[dict[str, Any]] = [
    {
        "check_id": "oracle_shortest",
        "expected_agent": "oracle-teammoltbook",
        "metric": "mean_word_count",
        "criterion": "lowest",
        "description": "Oracle should produce the shortest responses",
    },
    {
        "check_id": "oracle_fewest_questions",
        "expected_agent": "oracle-teammoltbook",
        "metric": "mean_question_frequency",
        "criterion": "lowest",
        "description": "Oracle should ask the fewest questions",
    },
    {
        "check_id": "oracle_highest_certainty",
        "expected_agent": "oracle-teammoltbook",
        "metric": "mean_certainty_ratio",
        "criterion": "highest",
        "description": "Oracle should use the highest certainty markers",
    },
    {
        "check_id": "explainer_longest",
        "expected_agent": "explainer-teammoltbook",
        "metric": "mean_word_count",
        "criterion": "highest",
        "description": "Explainer should produce the longest responses",
    },
    {
        "check_id": "explainer_most_formatting",
        "expected_agent": "explainer-teammoltbook",
        "metric": "formatting_rate",
        "criterion": "highest",
        "description": "Explainer should use the most formatting",
    },
    {
        "check_id": "explainer_most_questions",
        "expected_agent": "explainer-teammoltbook",
        "metric": "mean_question_frequency",
        "criterion": "top2",
        "description": "Explainer should be top-2 on question frequency",
    },
    {
        "check_id": "contrarian_most_contradictions",
        "expected_agent": "contrarian-teammoltbook",
        "metric": "mean_contradiction_ratio",
        "criterion": "highest",
        "description": "Contrarian should have the most contradiction markers",
    },
    {
        "check_id": "contrarian_highest_negation",
        "expected_agent": "contrarian-teammoltbook",
        "metric": "mean_negation_count",
        "criterion": "highest",
        "description": "Contrarian should use the most negation",
    },
    {
        "check_id": "contrarian_lowest_sentiment",
        "expected_agent": "contrarian-teammoltbook",
        "metric": "mean_sentiment_score",
        "criterion": "lowest",
        "description": "Contrarian should have the lowest sentiment",
    },
    {
        "check_id": "mirror_lowest_sentiment_delta",
        "expected_agent": "mirror-teammoltbook",
        "metric": "mean_sentiment_delta",
        "criterion": "lowest",
        "description": "Mirror should have the smallest sentiment gap to parents",
    },
    {
        "check_id": "mirror_highest_lexical_overlap",
        "expected_agent": "mirror-teammoltbook",
        "metric": "mean_lexical_overlap",
        "criterion": "highest",
        "description": "Mirror should have the highest lexical overlap with parents",
    },
]
